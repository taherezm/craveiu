...
export default function Home() {
  return (
    <div className="flex flex-col">
      {/* Hero */}
      <section className="relative overflow-hidden bg-white px-4 pb-24 pt-20 sm:pt-28">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-red-100 bg-red-50 px-4 py-1.5 text-sm font-medium text-red-700">
            <span className="h-1.5 w-1.5 rounded-full bg-red-500" />
            Built for IU Bloomington students
          </div>
          <h1 className="animate-slide-up text-5xl font-extrabold tracking-tight text-gray-900 sm:text-6xl lg:text-7xl">
            Skip the<br />
            <span className="text-[#990000]">menu hunt.</span>
          </h1>
          <p className="animate-slide-up delay-75 mx-auto mt-6 max-w-2xl text-xl text-gray-500 sm:text-2xl">
          ...
          <div className="animate-slide-up delay-150 mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            ...
            <Link
              href="/preferences"
              className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-8 py-4 text-base font-semibold text-gray-700 transition-all hover:border-gray-300 hover:bg-gray-50"
            >
              Set my cravings
            </Link>
          </div>
      ...
      <section className="border-y border-gray-100 bg-gray-50 py-4">
        <div className="mx-auto max-w-4xl overflow-hidden px-4">
          <p className="text-center text-sm text-gray-500">
            ...
            <span className="font-semibold text-gray-800">5 IU dining halls</span>
            {" "}·{" "}
            <span className="font-semibold text-gray-800">3 meal periods</span>
            {" "}·{" "}
            <span className="font-semibold text-gray-800">updated daily</span>
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={title}
                className={`animate-slide-up rounded-2xl border border-gray-100 bg-gray-50 p-6 delay-${i * 75}`}
              >
